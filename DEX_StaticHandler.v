...
Module DEX_StaticHandler.
  
  Import DEX_BigStep.DEX_Dom.DEX_Prog.

  Section DEX_subclass_test.
    Variable p : DEX_Program.
    Variable DEX_subclass_test : DEX_ClassName -> DEX_ClassName -> bool.
    Variable DEX_subclass_test_correct :
      forall c1 c2,
        if DEX_subclass_test c1 c2 then subclass_name p c1 c2
...
(*    Fixpoint search_handler (pc:PC) (c:ClassName)
    ...
    Qed.
*)
  End DEX_subclass_test.

End DEX_StaticHandler.

Module DEX_StaticHandlerProp.

  Import DEX_StaticHandler DEX_BigStep.DEX_BigStep DEX_Dom DEX_Prog.
